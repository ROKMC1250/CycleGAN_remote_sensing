...
class ColorizationModel(Pix2PixModel):
    ...
    def __init__(self, opt):
        ...
        # self.visual_names = ['real_A', 'fake_B_rgb']
        self.visual_names = ['fake_B_rgb']
    ...
    #     # print('original_Lab_matrix:',Lab[120,120,:])
    #     rgb1 = color.lab2rgb(Lab)
    #     rgb2 = color.lab2rgb(Lab) * self.max_value
    #     # print('Lab2rgb function:',rgb1[120,120,:])
    #     # print('Lab2rgb function * 255:',rgb2[120,120,:])
    #     return rgb2
    ...
    def lab2rgb(self,L,AB):
        ...
        rgb = np.multiply(rgb,self.max_value)
